...
public class PersonalHomeActivity extends BaseActivity {
	...
	//	ageTv.setText(user.getAge());
		...
		filesBtn.setOnClickListener(new OnClickListener() {			
			@Override
			public void onClick(View arg0) {
				Utils.jumpUI(PersonalHomeActivity.this, UserInfoActivity.class,true, true);
			}
		});
		//返回按钮
		Button backBtn = (Button)findViewById(R.id.act_personalhome_back_btn);
		backBtn.setOnClickListener(new OnClickListener() {			
			@Override
			public void onClick(View v) {
				Utils.jumpUI(PersonalHomeActivity.this, MainActivity.class,true, true);
			}
		});
		//访客清单按钮
		...
		diaryBtn.setOnClickListener(new OnClickListener() {			
			@Override
			public void onClick(View arg0) {
				Utils.jumpUI(PersonalHomeActivity.this, DiaryActivity.class,false,false);
			}
		});
		//瘦身方案按钮
		Button caseBtn = (Button)findViewById(R.id.act_personalhome_case_btn);
		caseBtn.setOnClickListener(new OnClickListener() {			
			@Override
			public void onClick(View arg0) {
				Utils.jumpUI(PersonalHomeActivity.this, FitnessCaseActivity.class,false,false);
			}
		});
	}
	@Override
